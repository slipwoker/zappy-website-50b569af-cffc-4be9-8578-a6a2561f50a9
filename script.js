// ============================================
// HAVAT HAGALIL - FARM WEBSITE JAVASCRIPT
// Mobile Navigation & Smooth Interactions
// ============================================
...
(function() {
  ...
  const animatedElements = document.querySelectorAll('.card-default, .experience-feature, .value-card, .team-member');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חוות הגליל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '50b569af-cffc-4be9-8578-a6a2561f50a9',
                    name: data.name || '',
                    email: data.email || '',
